    ...
    products: [
      {
        ...
        baseUrl: 'https://demo.mx402.exchange/providers/elrondcore-labs',
    ...
    products: [
      {
        ...
        baseUrl: 'https://demo.mx402.exchange/providers/xfinance-protocol',
    ...
    products: [
      {
        ...
        baseUrl: 'https://demo.mx402.exchange/providers/safechain-ai',
    ...
    products: [
      {
        ...
        baseUrl: 'https://demo.mx402.exchange/providers/nftlabs-mx',
    ...
    products: [
      {
        ...
        baseUrl: 'https://demo.mx402.exchange/providers/stake-anchor',
    ...
    products: [
      {
        ...
        baseUrl: 'https://demo.mx402.exchange/providers/trustlayer-protocol',
